...
- **2D_Data_Generator** - program which allows us to generate input files for the neural network. The basic idea of the process is visualized below.
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/generating_data_complex3.png">
    </p>
    Finally the whole research was performed od three datasets presented below:
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/dataset5.png">
    </p>
...
- **2D_Neural_Networks** - folder that consists of files with neural network architectures.
    ...
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/stage_0.png">
    </p>
    ...
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/stage_1_2.png">
    </p>
    ...
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/stage_1_3.png">
    </p>
    ...
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/stage_1_4.png">
    </p>
    ...
    <p align="center">
        <img width="800" src="https://github.com/mlaskowski17/Exploring-Design-Spaces/blob/master/images/stage_1_5.png">
    </p>
